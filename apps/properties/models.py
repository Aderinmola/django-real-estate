...
class Property(TimeStampedUUIDModel):
    ...
    tax = models.DecimalField(
        verbose_name=_("Property Tax"), max_digits=6, decimal_places=2,
    ...
    bathrooms=models.DecimalField(verbose_name=_("Bathrooms"), max_digits=4,
